...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Admin User'];
  const customerRoles: string[] = ['Regular User'];
  const tenantRoles: string[] = ['Moderator User', 'Admin User'];
  const addOns: string[] = ['chat', 'file', 'notifications'];
  const applicationName = `Buba i nana`;
